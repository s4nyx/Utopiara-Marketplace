...
export default function HomePage() {
  ...
  return (
    <section
      ...
      ref={component}
    >
      <div className="absolute right-0 lg:h-screen max-lg:h-[100vh] max-lg:w-full lg:w-[70%] ">
        <Image
          alt="background_1"
          src="/webp/home/background.webp"
          fill
          sizes="100vw"
          style={{
            objectFit: "cover",
          }}
          blurDataURL="/webp/home/background_blur.webp"
          placeholder="blur"
          priority
        />
        <Image
          ref={app}
          alt="background_2"
          src="/webp/home/background-1.webp"
          className="opacity-0"
          fill
          sizes="100vw"
          style={{
